...
<h3 className="w-[full] md:w-[464px] text-start h-[auto] font-Poppins not-italic font-bold text-[32px] leading-[48px] text-[#2AB6C5]"> React.js <span className="w-[464px] h-[48px] font-Poppins not-italic font-bold md:text-[32px] text-[30px] leading-[30px]  text-[#2C2C2C] text-start  ">course Overview</span></h3>
...
<div className=" mt-5 md:mt-0 flex flex-col space-y-5 md:w-[765px] h-auto font-Poppins not-italic font-normal text-[16px] leading-[24px] text-[#848484]">
<h3 className=" md:w-[564px] h-[auto] font-Poppins not-italic font-bold text-[32px] leading-[48px] text-[#2C2C2C]"> What you will learn in <span className="w-[464px] h-[48px] font-Poppins not-italic font-bold text-[32px] leading-[48px] text-[#2AB6C5]"> React. js?</span></h3>
{/* <p className="">CSS coding is a language which allows you to create great visually appealing web pages about the styles, fonts, colours. CSS describes about how HTML elements are displayed on the screen. CSS saves lots of work. These CSS style sheets are external which can be stored as CSS files </p> */}
...
<div className="relative flex items-center  md:w-[450px] justify-center md:left-10  child2" > <img className="  h-[230px] w-[300px] md:w-[350px] md:h-[300px]" src={ReactImg} /> </div>
</div>
{/* <div className="flex h-auto ">
